...
class BarcodeScannerProcessor(context: Context, zoomCallback: ZoomCallback?) :
  ...
  private var resultListener: BarcodeScanningResultListener? = null
  ...
  fun setResultListener(resultListener: BarcodeScanningResultListener) {
  ...
  override fun onSuccess(barcodes: List<Barcode>, graphicOverlay: GraphicOverlay) {
    ...
    if(resultListener != null) {
      resultListener?.onBarcodeScanningResultSuccess(barcodes)
    }
  }
  ...
  override fun onFailure(e: Exception) {
    ...
    if(resultListener != null) {
      resultListener?.onBarcodeScanningResultFailure(e)
    }
  }
