...
class RenalHealthActivity : BaseActivity() {
    ...
    private fun showColorCard() {
        binding.title = getString(R.string.renal_health)
        ...
        binding.llCard1.title = "Protein"
        binding.llCard2.title = "Creatinine"
        binding.llCard3.title = "Blood"
        binding.llCard4.title = "Ketone"

        binding.llCard1.content = "| Trace"
        binding.llCard2.content = "| Normal"
        binding.llCard3.content = "| Normal"
        binding.llCard4.content = "| Negative"
        ...
        binding.llCard2.layout1.backgroundTintList =
            ContextCompat.getColorStateList(this, R.color.creation_1)
        binding.llCard2.layout2.backgroundTintList =
            ContextCompat.getColorStateList(this, R.color.creation_2)
        binding.llCard2.layout3.backgroundTintList =
            ContextCompat.getColorStateList(this, R.color.creation_3)
        binding.llCard2.layout4.backgroundTintList =
            ContextCompat.getColorStateList(this, R.color.creation_4)
        binding.llCard2.layout5.backgroundTintList =
            ContextCompat.getColorStateList(this, R.color.creation_5)
        ...
        binding.llCard4.linear7.visibility = View.GONE
